...
def detecta_duplicados(lista):
    ...
    for l in lista:
        ...
        if count == 0:
            # A lista não tem duplicados, retorno = -1
            # print('Lista única')
            retorno.append(-1)
    return retorno
...
# print(len(detecta_duplicados(lista_de_listas_de_inteiros)))

print(detecta_duplicados(lista_de_listas_de_inteiros))

for lista in lista_de_listas_de_inteiros:
    print(detecta2(lista))
